...
void ComponentTab::render(const Transform4x4f& parentTrans)
{
	...
	{			
		...
		{				
			...
			Renderer::drawGradientRect(mSelectorBarOffset, 0.0f, selectedTabWidth, mSize.y(), selectorColor, selectorGradientColor, selectorGradientHorz, Renderer::Blend::ONE, Renderer::Blend::ONE);
		}
		else
		{
			...
			Renderer::drawGradientRect(mSelectorBarOffset, mSize.y() - SELECTOR_PX, selectedTabWidth, SELECTOR_PX, selectorColor, selectorGradientColor, selectorGradientHorz, Renderer::Blend::ONE, Renderer::Blend::ONE);
		}
	}
