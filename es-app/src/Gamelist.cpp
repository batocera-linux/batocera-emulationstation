...
{
	if (system == nullptr || !system->isGameSystem() || !system->isVisible()) // || system->hasPlatformId(PlatformIds::IMAGEVIEWER))
		return false;
...
void updateGamelist(SystemData* system)
{
	...
	if (!system->isGameSystem() || !system->isVisible()) // || system->hasPlatformId(PlatformIds::IMAGEVIEWER))
		return;
...
{
	if (!system->isGameSystem() || system->isCollection() || !system->isVisible()) //  || system->hasPlatformId(PlatformIds::IMAGEVIEWER)
		return;
