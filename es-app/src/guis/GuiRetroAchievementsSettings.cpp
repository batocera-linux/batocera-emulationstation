...
GuiRetroAchievementsSettings::GuiRetroAchievementsSettings(Window* window) : GuiSettings(window, _("RETROACHIEVEMENT SETTINGS").c_str())
{
  ...
  addSwitch(_("ENCORE MODE"), _("Reset achievements to be able to earn them again."), "global.retroachievements.encore", false):
	...
	addSwitch(_("SHOW RETROACHIEVEMENTS ENTRY IN MAIN MENU"), _("View your RetroAchievement stats right from ES's main menu!"), "RetroachievementsMenuitem", true, nullptr);
