...
std::vector<std::vector<std::string>> kbLayout =
{
	...
	{ "KEY_LEFTSHIFT", "KEY_Z", "KEY_X", "KEY_C", "KEY_V", "KEY_B", "KEY_N", "KEY_M", "KEY_COMMA", "KEY_DOT", "KEY_SLASH", "KEY_RIGHTSHIFT", "", "", "", "KEY_UP", "", "KEY_KP1", "KEY_KP2", "KEY_KP3", "KEY_KPENTER", "BTN_LEFT", "BTN_MIDDLE", "BTN_RIGHT" },
